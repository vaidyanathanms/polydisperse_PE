...
casearr  = [1;2;3;4];
pdi_freearr = [1.5];
arch_arr  = {'bl_bl';'al_al'}; %'bl_al';'al_bl';'al_al'};
leg_arr   = {'Block-Block';'Alter-Alter'}; %'Block-Alter';'Alter-Block';'Alter-Alter'}; % ALWAYS CHECK for correspondence with arch_arr for legends
pdigraft  = 1.0;
nfreemons = 30;
